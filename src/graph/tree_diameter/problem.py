...
2258（https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid/）binary_search|bfsimplemention
...
3958（https://www.luogu.com.cn/problem/P3958）build_graph|之后广度优先搜索
...
6207（https://www.luogu.com.cn/problem/P6207）广度优先搜索记录shortest_path径
...
===================================CodeForces===================================
1272E（https://codeforces.com/problemset/problem/1272/E）reverse_graph，多源BFS
1572A（https://codeforces.com/problemset/problem/1572/A）brain_teaserbuild_graph|，广度优先搜索是否存在环与无环时从任意起点的DAG最长路
