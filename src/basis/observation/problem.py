...
1185C2（https://codeforces.com/problemset/problem/1185/C2）data_range|bucket_cnt|greed
...
1687A（https://codeforces.com/problemset/problem/1687/A）observation|greed
1548A（https://codeforces.com/problemset/problem/1548/A）observation|brain_teaser|implemention
1408D（https://codeforces.com/problemset/problem/1408/D）brute_force|liner_dp|greed|brain_teaser|observation
...
class Solution:
    ...
    def cf_1185c2(ac=FastIO()):
        ...
        tag: data_range|bucket_cnt|greed
        """
    ...
    def main(ac=FastIO()):
        ...
        tag: brute_force|liner_dp|greed|brain_teaser|observation
        """
        n, m = ac.read_list_ints()
