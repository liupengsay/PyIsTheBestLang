...
===================================力扣===================================
1157. 子数组中占绝大多数的元素（https://leetcode.com/problems/online-majority-element-in-subarray/description/）查询区间的超级众数，即区间出现超过一半的数，同cf1514_d正解为随机化猜众数，或者位运算计算众数，或者线段树合并众数
